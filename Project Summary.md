...
**Comparisons:** three dropdowns — the quarter to summarise, a year-over-year comparison (defaulting to the same quarter one fiscal year earlier), and a second free comparison (defaulting to the immediately preceding quarter). Either comparison can be set to *None*.
