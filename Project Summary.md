...
**Reading that figure (documented in the About panel):** because Decline to State sits in the base, decliners push the Low share down, and in this program that effect dominates the trend. Low share falls 70.7% (FY23) → 62.8% → 60.3% → 56.1% (FY26), while Decline to State grows 83 → 159 students. Among choir students who actually named a bracket, **99–100% named a low one every year** (FY26: 206 Low vs 2 High; FY23–FY25: zero High at all). The declining percentage is a response-rate story, not a wealth story — report Low alongside Decline to State and No Response, and state which base is being used.
