...
export const REPORTS = [
  ...
  },
  {
    ...
    description: 'Every quarter on file as a chart — total enrollments over time, split by branch, lessons vs. group classes, or tuition status, with summer quarters optionally excluded.',
